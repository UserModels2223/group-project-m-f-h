...
for subject in os.listdir(directory):
    ...
    if os.path.isfile(path):
        if ".py" in subject or "Sander" in subject:
            continue
        print(subject)
        ...
        if audio_learner:
            audiovisual_num_correct.append(correct[1])
            audiovisual_num_wrong.append(correct[0])
        else:
            visual_num_correct.append(correct[1])
            visual_num_wrong.append(correct[0])
        ...
        if audio_learner:
            visual_facts_seen_audiovisuallearners.append(question_type[0])
            audiovisual_facts_seen_audiovisuallearners.append(question_type[1])
        else:
            visual_facts_seen_visuallearners.append(question_type[0])
            audiovisual_facts_seen_visuallearners.append(question_type[1])
